...
set COMPILE=g++ -std=c++23 -x c++ -g -c --coverage -pedantic-errors -Wall -Wextra -Wconversion -Wsign-conversion -Wnon-virtual-dtor -Werror
set LINK=g++ --coverage
...
%COMPILE% -o outputs\HasAllocatorBase.o sources\HasAllocatorBase.cpp || exit /b
...
%LINK% -o outputs\Main.exe outputs\CurrentProcess.o outputs\HeapAllocator.o outputs\Main.o outputs\StdCoutCharacterWriteStream.o outputs\HasAllocatorBase.o outputs\Allocator.o outputs\Counter.o || exit /b
...
%LINK% -o outputs\TestMain.exe outputs\AllocatorDecorator.o outputs\ByteCountingAllocator.o outputs\ByteCountingAllocatorTests.o outputs\CurrentProcess.o outputs\HeapAllocator.o outputs\StdCoutCharacterWriteStream.o outputs\Test.o outputs\TestAssertionFailure.o outputs\TestAssertionFailureTests.o outputs\TestGroup.o outputs\TestRunner.o outputs\TestMain.o outputs\TestTests.o outputs\TestRunnerTests.o outputs\PointerTests.o outputs\HeapAllocatorTests.o outputs\ByteTests.o outputs\ArrayListTests.o outputs\HasAllocatorBase.o outputs\Allocator.o outputs\CounterTests.o outputs\Counter.o outputs\CurrentProcessTests.o || exit /b