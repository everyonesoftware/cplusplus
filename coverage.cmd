...
mkdir outputs\coverage\lcov
grcov outputs --source-dir sources --binary-path outputs --branch --output-types lcov --output-path outputs\coverage\lcov\lcov.info > outputs\coverage\lcov\grcov.txt 2>&1